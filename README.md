...
The format is always `https://{host}/{endpoint}/[search,suggest]?q={searchQuery}`. XML description files are also provided. For an up-to-date list, simply query the main page.
